...
/* QEDPI's Latte */(function(){var Transposer;Transposer=__webpack_require__(1);$(function(){var animate_body,into_lines,pretty,scroll_speed,scroll_speed_fast,scroll_speed_medium,scroll_speed_slow,scroll_state_off,scroll_state_on,shareClipboard,share_link,stop_animation,temp,words;into_lines=function into_lines(text){return text.split('\n');};words=function words(line){return line.split(' ');};$('#transpose-up').click(function(){var lyrics_text;lyrics_text=$('#lyrics').text();return $('#lyrics').html(Transposer.transpose(lyrics_text).fromKey('Em').up(1)['text']);});$('#transpose-down').click(function(){var lyrics_text;lyrics_text=$('#lyrics').text();return $('#lyrics').html(Transposer.transpose(lyrics_text).fromKey('Em').down(1)['text']);});shareClipboard=new Clipboard('#share_link_passcode');temp=$('#test-case').text();pretty={val:2}; /**
	    #my docstring
	     *
	     */ /*
