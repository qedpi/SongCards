 ...
 */
function transposeSemitones(text, semitones, options) {
  return transpose(text, semitoneMapper(semitones), options);
}
 ...
 * chord. See chordSpanFormatter.
 */
function transposeToKey(text, newKey, options) {
 ...
 */
function transpose(text, mapper, options) {
  var currentKey = null, formatter;
